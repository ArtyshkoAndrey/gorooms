        ...
        <div class="section-header">
          ...
          <form id="search-filter" class="search-filter" method="get">
            ...
            <div class="search-filter-item search-filter-sort">
              <button class="search-filter-price-btn {{ $sortByRequested['sortByCost'] == 'desc' ? 'active' : '' }}" name="sortByCost" value="desc"></button>
              <button class="search-filter-price-btn {{ $sortByRequested['sortByCost'] == 'asc' ? 'active' : '' }}" name="sortByCost" value="asc"></button>
